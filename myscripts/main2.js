        ...
        while (cut <= numCut) {
            ...
            for (var i = 0; i < nodes5.length; i++) {
                ...
                for (var j = i + 1; j < nodes5.length; j++) {
                    ...
                    if (relationship[term1 + "__" + term2] && relationship[term1 + "__" + term2][m] >= cut2) {
                        var l = new Object();
                        l.source = nodes5[i];
...
function drawgraph2() {
    ...
    lNodes.sort(function (a, b) {
        if (a.m < b.m) { // order by month
            ...
            if (fileName.indexOf("EmptyWheel")>=0){
    ...
    var yStartHistogram = height + 175; // y starts drawing the stream graphs
    ...
    var yTextClouds = height + 190; // y starts drawing the stream graphs
